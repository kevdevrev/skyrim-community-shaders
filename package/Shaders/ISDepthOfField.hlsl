...
PS_OUTPUT main(PS_INPUT input)
{
	...
	{
		blurColor = SampleBlurredWithSoftening(imageTexCoord, input.Position.xy, invScreenRes.xy * DOF_DOWNSAMPLE_FACTOR);
	}
	else
	{
		blurColor = BlurredTex.Sample(BlurredSampler, imageTexCoord).xyz;
	}
